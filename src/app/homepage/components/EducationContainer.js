        ...
        <div className="w-full">
            <div className="bg-gray-800 rounded-xl shadow-md p-6">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <div>
                        <h3 className="font-semibold text-lg text-gray-300">{education.school}</h3>
                        <p className="text-gray-400">{education.major}</p>
                        <p className="text-gray-400">{education.extra}</p>
                        <p className="text-gray-500 text-sm">{education.gradYear}</p>
                    </div>
                </div>
            </div>
        </div>
